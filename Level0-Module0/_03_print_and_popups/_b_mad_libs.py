...
if __name__ == '__main__':
    ...
    libs = simpledialog.askstring("mad libs", "If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    adjective = simpledialog.askstring("mad libs","type a adjective")
    # Get the player to enter a type of liquid
    liqiud = simpledialog.askstring("mad libs","type the name of a liqud")
    # Get the player to enter a body part
    bodypart = simpledialog.askstring("mad libs","type the name of a body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring("mad libs","type a verb")
    # Get the player to enter a place
    place = simpledialog.askstring("mad libs","type a place")
    ...
    story = (
        ...
        "night. Piranhas are attracted to fresh " + liqiud + " and will most\n"
